...
export const Bot = (props: BotProps & { class?: string }) => {
    ...
    const allowSubmission = () => characterCount() <= characterLimit;

    // For making sure it only loads to the specific URL
    const [isChatUiVisible, setIsChatUiVisible] = createSignal(false);
          ...
          >
                ...
                <span style={{ 'font-family': 'Poppins, sans-serif' }}>Clear</span>
                    ...
                    <Badge
                        ...
                        characterCount={characterCount()} // Pass the character count state to Badge
                    />
